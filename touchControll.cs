...
public class touchControll : MonoBehaviour {
	...
	void Update () {
		...
		if(Input.touchCount == 2)
		{
			...
			Vector2 touch0_previousPoint = touch_0.position - touch_0.deltaPosition; // deltaPosition means newCurrentPosition
			Vector2 touch1_previousPoint = touch_1.position - touch_1.deltaPosition;

			float prevMagnitude = (touch0_previousPoint - touch1_previousPoint).magnitude;
